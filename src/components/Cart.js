                  ...
                  <div className="flex " key={item.name}>
                    <div className="flex place-items-start gap-4 flex-1 my-1 p-2 relative">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="counter flex place-items-center mt-6 w-[120px] cursor-pointer">
                          <span
                            className="down px-[10px] py-1 text-white bg-orange-400"
                            onClick={() => {
                              decreaseCount(
                                name,
                                defaultPrice / 100 || price / 100
                          ...
                          />
                          <span
                            className="up py-1 text-white px-[10px] bg-orange-400"
                            onClick={() => {
                              increaseCount(
                                name,
                                defaultPrice / 100 || price / 100
