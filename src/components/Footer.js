          ...
          <div className="flex flex-wrap -mx-4">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="w-full mb-10">
                <a href="/#" className="mb-6 inline-block max-w-[80px]">
                  <img
                    src={logo}
                    alt="logo"
            ...
            <LinkGroup header="Company">
              ...
              <NavLink link="/#" label="GoodFood One" />
              <NavLink link="/#" label="GoodFood Instamart" />
            </LinkGroup>
            ...
            <LinkGroup header="Quick Links">
              <NavLink link="/#" label="Help & Support" />
              <NavLink link="/#" label="Our Services" />
              <NavLink link="/#" label="Partner with us" />
            </LinkGroup>
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="w-full mb-10">
                ...
                <div className="flex items-center mb-6">
                  <a
                    href="/#"
                    className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] text-dark hover:border-orange-400  hover:text-orange-400 sm:mr-4 lg:mr-3 xl:mr-4"
                  >
                    <svg
                      width={8}
                      height={16}
  ...
  return (
    <div>
      <li>
        <a
          href={link}
          className={`inline-block mb-2 text-base leading-loose text-body-color hover:text-orange-400`}
        >
          {label}
        </a>
      </li>
